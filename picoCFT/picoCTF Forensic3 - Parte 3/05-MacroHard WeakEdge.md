He escondido una bandera en este archivo. ¿Puedes encontrarla? [La ciencia forense es divertida.pptm](https://mercury.picoctf.net/static/c0da20f29337e87ffb58ea987d8c596e/Forensics%20is%20fun.pptm)
...
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro$ ls
'Forensics is fun.pptm'
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro$ unzip Forensics\ is\ fun.pptm
...
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro$ cd ppt/slideMasters/hidden
-bash: cd: ppt/slideMasters/hidden: Not a directory
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro$ ls
'[Content_Types].xml'   docProps  'Forensics is fun.pptm'   ppt   _rels
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro$ cd ppt
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro/ppt$ cd slideMasters
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro/ppt/slideMasters$ ls
hidden  _rels  slideMaster1.xml
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro/ppt/slideMasters$ cat hidden
Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1brisgbrbbrisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro/ppt/slideMasters$ cat hidden | tr -d ' '
ZmxhZzogcGljb0NURntEMWRfdV9rbjB3X3BwdHNfcl96MXA1fQbrisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro/ppt/slideMasters$ cat hidden | tr -d ' ' |base64 -d
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}base64: invalid input
brisguz@DESKTOP-8V24E1B:~/SegPrac/pico/for3/macro/ppt/slideMasters$
```
