...
Hints:
1. En proyectos colaborativos, muchos usuarios pueden realizar muchos cambios. ¿Cómo puedes ver los cambios dentro de un archivo?
2. Lea el capítulo sobre Git de picoPrimer [aquí](https://primer.picoctf.org/#_git_version_control) .
3. Puedes usarlo `python3 <file>.py`para intentar ejecutar el código, aunque no será necesario para este desafío.

## Solución:
```

grbau21-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c_titan/157/challenge.zip
--2025-02-22 20:53:31--  https://artifacts.picoctf.net/c_titan/157/challenge.zip
...
challenge.zip                                   100%[======================================================================================================>] 286.71K  1.85MB/s    in 0.2s    

2025-02-22 20:53:31 (1.85 MB/s) - 'challenge.zip' saved [293587/293587]
...
replace drop-in/.git/hooks/post-update.sample? [y]es, [n]o, [A]ll, [N]one, [r]ename: All
...
grbau21-picoctf@webshell:~/drop-in$ git log message.py
